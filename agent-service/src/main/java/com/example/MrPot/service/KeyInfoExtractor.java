...
public final class KeyInfoExtractor {
    ...
    public static KeyInfo extract(String answerText) {
        ...
        for (String raw : lines) {
            ...
            if (line.contains("步骤") || line.toLowerCase().contains("steps")) inStep = true;
            ...
            if (m2.find()) {
                if (inStep) steps.add(m2.group(1).trim());
        ...
        return new KeyInfo(steps.stream().limit(12).toList(),
                points.stream().limit(8).toList());
    }
}
